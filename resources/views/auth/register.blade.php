    ...
    <div class="text-white">
      <div class="mb-8 flex flex-col items-center">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full pl-2 py-1 text-black px-28" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full pl-2 py-1 text-black px-28" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full pl-2 py-1 text-black px-28"
                            type="password"
                            name="password"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full pl-2 py-1 text-black px-28"
                            type="password"
